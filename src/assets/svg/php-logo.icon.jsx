...
const PhpLogo = ({ id, role, title, focusable, clickHandler }) => {
    return (
        <svg
            id={id}
            role={role}
        ...
        >
            <title>{title}</title>
            <defs>
                <radialGradient id="a" cx=".8366" cy="-125.811" r="363.0565" gradientTransform="matrix(.463 0 0 .463 76.4644 81.9182)" gradientUnits="userSpaceOnUse">
